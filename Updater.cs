...
namespace UniShield
{
    class Updater
    {
        public Updater(byte[] updateFileStream)
        {
            ...
            UpdateDownloadName = "UniShield-Update_v" + LatestVersion + ".zip";
        ...
        void wc_DownloadFileCompleted(object sender, System.ComponentModel.AsyncCompletedEventArgs e)
        {
            ...
            p.StartInfo.Arguments = "/K timeout /T 1 /nobreak && cd " + AppDomain.CurrentDomain.BaseDirectory + " && 7z.exe e -y " + UpdateDownloadName + " && start UniShield.exe " + '"' + Program.path + '"' + " && exit";
